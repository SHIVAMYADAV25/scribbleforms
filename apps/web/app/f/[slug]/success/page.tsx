...
import { Compass, PlusCircle, LayoutDashboard, Share2, FileText, PenTool, BarChart3 } from "lucide-react";
    ...
    >
      ...
      <div style={{ width: "100%", display: "flex", justifyContent: "space-between", alignItems: "center", zIndex: 10, flexShrink: 0 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "24px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "6px", fontSize: "14px", fontWeight: 700, color: "#5a4a30", opacity: 0.8, cursor: "pointer" }}>
          ...
          <button style={{ display: "inline-flex", alignItems: "center", gap: 6, fontSize: 14, fontWeight: 700, cursor: "pointer", border: "none", background: "transparent", position: "relative", padding: "8px 16px" }}>
      ...
      {/* ── UNIFIED WRAPPER TO ATTACH SHELF DIRECTLY UNDER THE ARTWORK GROUND LINE ── */}
      <div 
        style={{
          flex: 1,
          display: "flex",
          flexDirection: "column",
          alignItems: "center",
          justifyContent: "center", // Vertically centers the entire unified block assembly in the remaining screen space
          width: "100%",
          maxHeight: "calc(100vh - 10px)",
          boxSizing: "border-box",
          marginTop: "-65px" // Pulls scene structure up away slightly from structural footer limits
        }}
      >
        ...
        <div 
          style={{
            display: "flex",
            alignItems: "flex-end", // Anchors illustration firmly down onto its own bounding boundary base
            justifyContent: "center",
            width: "100%",
            height: "52%", // Restricts upper growth bounds to preserve room below
            boxSizing: "border-box",
          }}
        >
          <img 
        ...
        {/* ── 3. BOTTOM WHAT'S NEXT ACTIONS SHELF (ATTACHED PERFECTLY BELOW BASE GROUND LINE) ── */}
        <div 
          style={{ 
            position: "relative", 
            width: "1080px", 
            ...
            marginTop: "4px", // Tiny cosmetic space directly under the sketched ground horizon line
            flexShrink: 0
          }}
        >
          ...
          <div style={{ position: "relative", zIndex: 1, display: "grid", gridTemplateColumns: "repeat(4, 1fr)", width: "100%", height: "100%" }}>
            ...
            <div style={{ display: "flex", alignItems: "flex-start", gap: "12px", padding: "0 10px", borderRight: "1px dashed rgba(45,36,22,0.15)" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                ...
                <button style={{ width: "fit-content", padding: "4px 12px", fontSize: "11px", fontWeight: 700, background: "#ede8f9", border: "1px solid #2d2416", borderRadius: "6px", cursor: "pointer" }}>Explore Forms →</button>
              </div>
            </div>
            ...
            <div style={{ display: "flex", alignItems: "flex-start", gap: "12px", padding: "0 16px", borderRight: "1px dashed rgba(45,36,22,0.15)" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                ...
                <button style={{ width: "fit-content", padding: "4px 12px", fontSize: "11px", fontWeight: 700, background: "#e8f5e9", border: "1px solid #2d2416", borderRadius: "6px", cursor: "pointer" }}>Create Form →</button>
              </div>
            </div>
            ...
            <div style={{ display: "flex", alignItems: "flex-start", gap: "12px", padding: "0 16px", borderRight: "1px dashed rgba(45,36,22,0.15)" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                ...
                <button style={{ width: "fit-content", padding: "4px 12px", fontSize: "11px", fontWeight: 700, background: "#ffecc2", border: "1px solid #2d2416", borderRadius: "6px", cursor: "pointer" }}>Go to Dashboard →</button>
              </div>
            </div>
            ...
            <div style={{ display: "flex", alignItems: "flex-start", gap: "12px", padding: "0 10px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                ...
                <button style={{ width: "fit-content", padding: "4px 12px", fontSize: "11px", fontWeight: 700, background: "#e1f5fe", border: "1px solid #2d2416", borderRadius: "6px", cursor: "pointer" }}>Share Form →</button>
              </div>
            </div>
